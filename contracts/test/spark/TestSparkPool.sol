...
import {TestSparkSPToken} from "./TestSparkSPToken.sol";

contract TestSparkPool is AdminHelperUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    /// @notice asset => atoken
    mapping(address => TestSparkSPToken) public tokenToAToken;
    ...
    function addAToken(address asset_, address aToken_) external onlyAdmin {
        ...
        tokenToAToken[asset_] = TestSparkSPToken(aToken_);
    }
}
